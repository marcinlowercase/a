...
//        if (link && link.href) {
//            // Send message to the Native App (Kotlin)
//            // "browser" is the native port name we will define in Kotlin
...
//
//
//    // Optional: Watch for changes (if a Single Page App updates the icon)
//    var observer = new MutationObserver(findFavicon);
